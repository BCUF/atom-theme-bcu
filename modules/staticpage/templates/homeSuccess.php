    ...
    <?php slot('sidebar') ?>
		...
		<section>
			...
			<ul>
				...
				<!-- </?php slot('title') ?> -->
					<input style="display: none;" type="button" id="fullwidth-treeview-reset-button" class="c-btn c-btn-submit" value="<?php echo __('Reset') ?>" />
					<input style="display: none;"  type="button" id="fullwidth-treeview-more-button" class="c-btn c-btn-submit" data-label="<?php echo __('%1% more') ?>" value="" />
