<section style="width: 60%;" class="admin-message" id="error-404">
    ...
    <?php if ('fr' == $sf_user->getCulture()) : ?>
        <?php echo '<h1>Ce document est accessible sur le poste de consultation des Archives électroniques à la BCU Beauregard.</h1>' ?>
    <?php else : ?>
        <?php echo '<h1>Dieses Dokument ist an der Station der elektronische Archivierung in der KUB Beauregard zu konsultieren.</h1>' ?>
    <?php endif; ?>
