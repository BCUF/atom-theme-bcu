...
<html lang="<?php echo $sf_user->getCulture(); ?>" dir="<?php echo sfCultureInfo::getInstance($sf_user->getCulture())->direction; ?>">
  <head>
    ...
    <script defer src="/plugins/arBcuPlugin/dist/js/vendor.bundle.1697f26639ee588df9ee.js"></script><script defer src="/plugins/arBcuPlugin/dist/js/arBcuPlugin.bundle.2239ab28d8f5940072bd.js"></script><link href="/plugins/arBcuPlugin/dist/css/arBcuPlugin.bundle.9106440577ec487cf3aa.css" rel="stylesheet">
