        ...
        <div id="header-nav-container" class="span5">
          ...
          <ul style id="header-nav" class="nav nav-pills pull-right">
            ...
            if ((!$sf_user->isAuthenticated()) && (strpos($actual_link, $local_url) !== false)) {
              echo '<li><a href="https://atomqa.local.bcu-fribourg.ch/index.php/user/login" title="Ouverture de session"><i class="bcu-browse-icon bi bi-box-arrow-in-right" style="color: #555555;font-size: 20px;" aria-hidden="true"></i></a></li>';
            }
