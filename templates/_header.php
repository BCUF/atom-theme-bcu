  ...
  <div class="container">
    ...
    <div id="header-lvl1">
      <div class="row">
        ...
        <!-- bouton feedback PC -->
        <?php if ('fr' == $sf_user->getCulture()) : ?>
          <a id="feedback-link" href="/feedback" target="self" title="Votre avis nous intéresse !"><img id="feedback-img" src="/plugins/arBcuPlugin/images/feedbackIconRight.svg"></img></a>
        <?php else : ?>
          <a id="feedback-link" href="/feedback" target="self" title="Ihre Meinung ist uns wichtig !"><img id="feedback-img" src="/plugins/arBcuPlugin/images/feedbackIconRightDE.svg"></img></a>
        <?php endif; ?>

        <!-- bouton feedback mobile -->
        <?php if ('fr' == $sf_user->getCulture()) : ?>
          <a id="feedback-link-mobile" href="/feedback" target="self" title="Votre avis nous intéresse !"><img id="feedback-img-mobile" src="/plugins/arBcuPlugin/images/feedbackIconRightSmall.svg"></img></a>
        <?php else : ?>
          <a id="feedback-link-mobile" href="/feedback" target="self" title="Ihre Meinung ist uns wichtig !"><img id="feedback-img-mobile" src="/plugins/arBcuPlugin/images/feedbackIconRightSmall.svg"></img></a>
        <?php endif; ?>
